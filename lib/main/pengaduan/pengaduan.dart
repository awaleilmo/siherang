                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration: new InputDecoration(
                        ...
                        labelText:
                            'Nama Kegiatan dan atau Usaha( Jika diketahui )',
                        labelStyle: TextStyle(
                            color: Colors.grey,
                            fontSize: 18,
                            fontWeight: FontWeight.bold),
                    ...
                    Container(
                      alignment: Alignment.centerLeft,
                      child: AutoSizeText(
                        'Waktu diketahuinya pencemaran dan atau perusakan lingkungan dan/atau perusakan hutan:',
                        style: TextStyle(
                    ...
                    Container(
                      alignment: Alignment.centerLeft,
                      child: AutoSizeText(
                        'Dampak yang dirasakan akibat pencemaran dan atau perusakan lingkungan dan/atau perusakan hutan:',
                        style: TextStyle(
                            fontWeight: FontWeight.normal, fontSize: 16),
                        textAlign: TextAlign.left,
                      ),
                      ...
                      child: FlutterMap(
                        options: MapOptions(
                            ...
                            onTap: (TapPosition,LatLng Location) {
                              _test(lokasiLat = Location.latitude,
                                  lokasiLng = Location.longitude);
                            }),
                        children: [
                          TileLayer(
                              urlTemplate:
                          ...
                          MarkerLayer(markers: mar ? [_marker()] : []),
                        ],
                      ),
                    ),
                    _padding(),
                    MaterialButton(
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(
                            context, SlideLeftRoute(page: PengPage()));
                      },
                      color: ColorPalette.underlineTextField,
                      child: AutoSizeText(
                        'Kirim',
